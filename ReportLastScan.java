...
public class ReportLastScan {
    ...
    public void generate(StringBuilder report, Model model) throws Exception {
        ...
        // add name and desc
        ExtensionNewReport newreport = (ExtensionNewReport) Control.getSingleton().getExtensionLoader().getExtension( ExtensionNewReport.NAME );
        report.append("<name>");
        report.append( newreport.getReportName() );
        report.append("</name>");
        report.append( "<desc>" );
        report.append( newreport.getReportDescription() );
        report.append( "</desc>" );
